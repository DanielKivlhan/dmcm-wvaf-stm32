...
Mode:
  ☐ IN0  (PA0) — tidak diaktifkan (tidak dipakai)
  ☑ IN1  (PA1) — aktifkan  → LM35 VOUT
...
│                                                      │
│ Rank 1:                                              │
│   Channel       : Channel 1  (PA1) — LM35 VOUT      │
...
|---|---|---|---|
| **ADC1 CH1** | Single-ended | PA1 | 12-bit, Scan ON, Continuous ON, 56 cycles (LM35) |
